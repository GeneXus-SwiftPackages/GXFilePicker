...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFilePicker",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFilePicker-1.0.0-beta+20230610052334.xcframework.zip",
			checksum: "267d1e75e9ada0d3639c2a08c54bb96f69a7935941409f4ca3b2e6e4b13625fb"
		)
	]
)
...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFilePicker",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFilePicker-1.0.0-beta+20230609175617.xcframework.zip",
			checksum: "8f88508894d5a7eb82e2c4db9de92d594bf318f2ca333f2f16de09cd6b0754fd"
		)
	]
)